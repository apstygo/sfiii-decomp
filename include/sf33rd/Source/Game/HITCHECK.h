...
s32 hit_check_x_only(WORK *wk1, WORK *wk2, const s16 *hd1, s16 *hd2);
void cal_hit_mark_position(WORK *wk1, WORK *wk2, const s16 *hd1, s16 *hd2);
void get_target_att_position(WORK *wk, s16 tx, s16 ty);
s16 get_att_head_position(WORK_Other *wk); // change to WORK?
